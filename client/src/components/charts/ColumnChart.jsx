...
function ColumnChart() {
  ...
  console.log(
    parseInt(now) - parseInt(moment(routes[0].created).format("YYYYMMDD"))
  );
    ...
    data: [
      {
        ...
        dataPoints: [
          ...
          {
            label: "Actual /Month",
            y: dayCalc + weekCalc + monthCalc,
            color: "OliveDrab",
          },
          // { label: "US Avg. /Month", y: 1383.33, color: "YellowGreen" },
          {
            label: "Actual /Year",
            y: dayCalc + weekCalc + monthCalc + yearCalc,
            color: "OliveDrab",
          },
